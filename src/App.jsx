...
const leadInFlight = useRef(false);
  ...
  const LED={te:{tag:"నీ Analysis Save చేసుకో",th:"Report సిద్ధంగా ఉంది.",tg:"ఎవరికి పంపాలో చెప్పు.",rev:"K Prasad personal గా review చేస్తారు.",sub:"మీ full report మీ Email కి వస్తుంది.",nl:"మీ పేరు",np:"మీ పేరు రాయండి",wl:"WhatsApp Number",wp:"10-digit number రాయండి...",eml:"Email Address",emp:"మీ email రాయండి...",el:"మీ Trading Experience",lvls:[{v:"beginner",l:"Beginner — Trading start చేశాను"},{v:"struggling",l:"Struggling — Losses అవుతున్నాయి"},{v:"inconsistent",l:"Inconsistent — కొన్నిసార్లు profit, కొన్నిసార్లు loss"},{v:"experienced",l:"Experienced — System కోసం వెతుకుతున్నా"}],sub2:"నా Report పంపించు →",send:"పంపిస్తున్నాను...",sent:"✅ Report పంపించాము! మీ Email check చేయండి.",priv:"మీ details ఎవరికీ share చేయం. Spam రాదు.",eN:"పేరు రాయి",eW:"Valid WhatsApp number రాయండి",eE:"Valid email రాయి",eL:"Level select చేయి"},en:{tag:"Save Your Analysis",th:"I will send your analysis.",tg:"Tell me who you are.",rev:"K Prasad personally reviews it.",sub:"Your full report will be sent to your Email.",nl:"Your Name",np:"Enter your name...",wl:"WhatsApp Number",wp:"Enter 10-digit number...",eml:"Email Address",emp:"Enter your email...",el:"Your Trading Experience",lvls:[{v:"beginner",l:"Beginner — Just started trading"},{v:"struggling",l:"Struggling — Taking regular losses"},{v:"inconsistent",l:"Inconsistent — Sometimes profit, sometimes loss"},{v:"experienced",l:"Experienced — Looking for a system"}],sub2:"Send My Report →",send:"Sending...",sent:"✅ Report sent! Check your Email.",priv:"Your details are never shared. No spam.",eN:"Enter your name",eW:"Enter valid WhatsApp number",eE:"Enter valid email",eL:"Select your level"}};
    ...
    return(
      <div style={sec}>
        <div style={{textAlign:"center",marginBottom:52}}>
          ...
          {/* A person reviews it — the real reason to leave a name. Shown directly under
              the headline, a step above the delivery line. */}
          <p className={lc} style={{color:G.smoke,fontSize:16,fontWeight:600,lineHeight:1.8,margin:"0 0 6px"}}>{LL.rev}</p>
    ...
    const verifyPayment = async (orderId) => {
      try {
        ...
        if(data.success) {
          ...
          // Conversion value = ₹3,000 base price (GST excluded — that is the
          // business revenue Google Ads optimises toward). Both the direct Ads
          // conversion and the GA4 `purchase` use the same figure so the two
          // measurement paths agree. transaction_id dedupes a reloaded success
          // screen. Fires ONCE here, only on verified payment success.
          track("purchase", {
            value: 3000, currency: "INR", transaction_id: orderId,
            items: [{ item_id: "mpv_journal_annual", item_name: "MPV Journal — Annual Access", price: 3000, quantity: 1 }],
          });
          adsConversion("journal_purchase", { value: 3000, currency: "INR", transaction_id: orderId });
        } else {
